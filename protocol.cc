 ...
 * @LastEditTime: 2023-09-16 14:32:02
...
extern "C"
{
    ...
    const unsigned char VPN_LABEL[VPN_LABEL_LEN] = {0x10, 0x11}; // vpn数据标记
    const unsigned char RECORD_TYPE_DATA[RECORD_TYPE_LABEL_LEN] = {0x11, 0x11};
    const unsigned char RECORD_TYPE_CONTROL[RECORD_TYPE_LABEL_LEN] = {0x12, 0x11};
    const unsigned char RECORD_TYPE_AUTH[RECORD_TYPE_LABEL_LEN] = {0x12, 0x12};
    const unsigned char RECORD_TYPE_ALARM[RECORD_TYPE_LABEL_LEN] = {0x12, 0x13};
